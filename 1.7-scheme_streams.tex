...
\end{lstlisting}
  ...
  \item \evalsto{(map-stream + nats ones)}{1 2 3 4 ...}
    ...
    \end{itemize}
  \item \evalsto{(map-stream list nats (map-stream + nats nats ones))}{(0 1) (1 3) (2 5) (3 7) ...}
  \end{itemize}
\end{frame}
...
(define (sieve stream)
  (cons-stream (head stream)
               (sieve (filter-stream (notdivides (head stream)) (tail stream)))))@\pause@
