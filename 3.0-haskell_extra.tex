...
\end{lstlisting}
  \onslide<+->
  Можем да дефинираме \alt<+->{\alt<+->{\alt<+->{\lst{fmap = (<*>) . pure}}{\lst{fmap f = (<*>) (pure f)}}}{\lst{fmap f x = (<*>) (pure f) x}}}{\lst{fmap f x = pure f <*> x}}.\\
  \onslide<+->
...
% LocalWords:  liftM mf filterM foldM boundSum lim PairsList enums
% LocalWords:  getChar getLine putChar putStr putStrLn
